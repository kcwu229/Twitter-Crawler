    ...
    Rectangle {
        ...
        Image {
            ...
            CustomTextField {
                ...
                height: 40
                opacity: 1
                text: "f6wbsfIsDGInCsBXDAFPjfMU2Zc5qT2nTZhHKmjUVMUOsm1RUB"
            ...
            CustomTextField {
                ...
                height: 33
                opacity: 1
                text: "1449802836942807051-FIT24Nh8Rb6P9f2AtpZodHtB7nyY7N"
                anchors.left: parent.left
                anchors.right: parent.right
                horizontalAlignment: Text.AlignHCenter
                anchors.leftMargin: 297
            ...
            CustomTextField {
                ...
                height: 33
                opacity: 1
                text: "oZOc0DfnDQHt7TJPfg7deNDa2ZsIuRlMXZTQ4YoFRiGju"
                anchors.left: parent.left
                anchors.right: parent.right
                horizontalAlignment: Text.AlignHCenter
                anchors.leftMargin: 297
            ...
            CustomTextField {
                ...
                visible: true
                color: "#ffffff"
                text: "hqpqsemDOOpW1uLUatxhF6dbH"
                anchors.left: parent.left
                anchors.right: parent.right
                horizontalAlignment: Text.AlignHCenter
                anchors.rightMargin: 77
